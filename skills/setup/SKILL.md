...
the colon form, not the bare words**: live prose discusses "FILL IN blocks", so `grep 'FILL IN'`
...
**The rest, only where the repo makes them relevant**, batched with the above:
